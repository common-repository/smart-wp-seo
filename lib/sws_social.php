...
function sws_social() {
    echo "<h2>" . __( 'Social Info', 'menu-sws' ) . "</h2>";
	...
	<input type="hidden" name="action" value="update" />
	 <?php wp_nonce_field('seo_meta_tags'); ?>				
		...
		<table class="form-table">     
                    <?php sws_input_text_field('smt_facebookpage_url','Facebook Page URL:','Facebook Publisher/Author URL:');?>
                    <?php sws_input_text_field('smt_twitter_username','Twitter Username:');?>
                    <?php sws_input_text_field('smt_google_publisher_page','Google Plus Posts Page:');?>
