 ...
 */
add_action('update_seo_meta_tags', 'sws_site_admin_options_process');

//ref taken from - http://codex.wordpress.org/Data_Validation
function sws_site_admin_options_process() {
...
function sws_site_admin_options() {	
...
<div class="wpsmt_content_wrapper">
    <div id="wpsmt_content_top" class="wpsmt_content_cell">
        <div class="tool-box">
	<h3 class="title"><?php _e(SWS_PLUGIN_TITLE) ?></h3> 
        <p>You can enter your meta keywords and description for your homepage.</p>
        <p>This plugin will add Meta description for each individual post as your excerpt of your post.</p>
	<p>This will help your blog to rank better in google. You can easily increase your blog traffic using this plugin.</p>
	...
	<input type="hidden" name="action" value="update" />
	 <?php wp_nonce_field('seo_meta_tags'); ?>				
		...
		<table class="form-table">     
                    <?php sws_input_text_field(SMT_HOME_KEYWORDS, 'Homepage Meta Tags Keywords');?>
				...
				<label for='seo_meta_tags[keywords]'>Example: <code>&lt;meta name='keywords' content='<strong><font color="blue">wp,Social Networking, Social Media, News, Web, Technology, Web 2.0, Tech, Information, Blog, Facebook, YouTube, Google, Top,Main Page,About wp,Advanced Topics,Backing Up Your Database,Backing Up Your wp Files,Blog Design and Layout,CSS,Contributing to wp,Core Update Host Compatibility,Database Description,Developer Documentation</font></strong>'&gt;</code></label>
                        ...
                        <?php sws_input_textarea_field(SMT_HOME_DESCRIPTION, 'Homepage Meta Tags Description');?>
                        <tr>
				<td colspan='2'>
