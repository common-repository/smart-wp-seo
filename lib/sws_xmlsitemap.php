 ...
 */
function sws_xmlsitemap() {
    echo "<h2>" . __( 'XML Sitemap', 'menu-sws' ) . "</h2>";
...
register_activation_hook(__FILE__, 'register_swssettings');
...
function register_swssettings() {	
   ...
   add_action('stm_cron', 'sws_sitemap');
